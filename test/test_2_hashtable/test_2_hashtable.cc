...
HashTable<const char*, int> hashtable = HashTable<const char*, int>();
...
void test_hashtable_set(void) {
  HashTableEntry<const char*, int>* entry = hashtable.set("test", 1);
...
void test_hashtable_overwrite(void) {
  HashTableEntry<const char*, int>* entry = hashtable.set("test", 2, false);
...
void test_hashtable_get(void) {
  HashTableEntry<const char*, int>* entry = hashtable.get("test");
